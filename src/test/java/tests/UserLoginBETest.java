...
public class UserLoginBETest extends SharedData {
    ...
    public void userTest() {
        ...
        userService.checkUser(responseLoginBody.getAccess_token(),responseBody.getId(), RequestStatusType.RESPONSE_OK);
        ...
        userService.checkUser(responseLoginBody.getAccess_token(),responseBody.getId(), RequestStatusType.RESPONSE_UNAUTHORIZED);
    }
}
