...
public class ReportBETest {
    ...
    public void testMethod(){
        ...
        //Pasul 1: Logare user admin
        System.out.println("STEP 1: LOGIN USER ADMIN");
        ...
        ResponseUserLoginModel responseBody5 = response.getBody().as(ResponseUserLoginModel.class);
        Assert.assertEquals(response.getStatusCode(), 200);

        //Pasul 2: Generam raportul de vanzari pe luna
